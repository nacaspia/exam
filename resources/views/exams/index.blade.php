                ...
                <div class="panel">
                    <div class="panel-header">
                        ...
                        <div class="btn-box d-flex flex-wrap gap-2">
                            ...
                            <a href="{{ route('exams.create') }}" class="btn btn-sm btn-primary"><i class="fa-light fa-plus"></i>{{ __('content.new') }}</a>
                        </div>
                    </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('exams.destroy', $delete['id']) }}" method="POST" class="delete-role-form">
                                @csrf
                                @method('DELETE')
