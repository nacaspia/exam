<div class="card mb-3 question-item">
    ...
    <div class="card-body">
        <ul class="nav nav-pills mb-3 question-tabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link question-other-tab" type="button" data-bs-toggle="tab" data-bs-target="#">
                    Digər
                </button>
            </li>
        </ul>
                    ...
                    <div class="tab-pane fade @if($k==0) show active @endif question-lang-pane"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control q-text ck-question-text"
                                          rows="4"
            ...
            <div class="tab-pane fade question-other-pane" role="tabpanel">
                <div class="row g-3">
                    ...
                    <div class="col-12 short-text-block" style="display:none">
                        ...
                        <textarea class="form-control correct-answer ck-question-correct-answer" rows="3"></textarea>
                    </div>
                </div>
            </div>
        </div>
