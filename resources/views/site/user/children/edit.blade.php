        ...
        <div class="container-fluid">
            ...
            <div class="admin-top-bar students-top">
                <div class="courses-select">
                    ...
                    <h4 class="title">{{ __('site.edit_child') }}</h4>
                </div>
            </div>
            <!-- Student Top End -->
            ...
            <div class="settings-wrapper">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="childForm"  action="{{ route('site.user.children.update',['locale' => app()->getLocale(),'id' => $children['id']]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <!-- Name -->
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text"
                                       name="surname" value="{{$children['surname']}}"
                                       class="form-control">
                                ...
                                <select name="class_id" class="form-control">
                                    ...
                                    @if(!empty($classes[0]))
                                        @foreach($classes as $class)
                                            <option value="{{$class['id']}}" @if($class['id'] ===$children['class_id']) selected @endif>{{ $class['name'][language()] }}</option>
                                        @endforeach
                                    @endif
                                </select>
