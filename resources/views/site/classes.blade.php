                            ...
                            <div class="col-lg-4 col-md-6 col-sm-8">
                                <div class="single-courses mt-30">
                                    <div class="courses-thumb">
                                        <img src="{{ $class->image? asset('storage/'.$class->image) : asset('site/assets/images/courses-grid-1.jpg') }}">
                                    ...
                                    <div class="courses-content">
                                        <a href="{{ route('site.exams',['locale' => app()->getLocale(), 'class_id' => $class->id]) }}">
                                            <h4 class="title">{{ $class->name[language()] }}</h4>
                                        </a>
                                    </div>
                                </div>
                            </div>
