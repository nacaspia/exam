                                    ...
                                    <div class="cat-group">
                                        ...
                                        <div class="sub-cat-group" >
                                            @foreach($label['permissions'] as $permission)
                                                <div class="form-check">
                                                    <input class="form-check-input" name="permissions[]"  {{ in_array($permission['id'], old('permissions', $selectedPermissions)) ? 'checked' : '' }} value="{{ $permission['id'] }}" type="checkbox" id="cat{{$permission['permission_label_id']}}">
