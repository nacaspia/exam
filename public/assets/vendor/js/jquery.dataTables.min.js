...
sNext:"<i class='fa-light fa-angle-right'></i>",sPrevious:"<i class='fa-light fa-angle-left'></i>"},sEmptyTable:"No data available in table",sInfo:"",sInfoEmpty:"",sInfoFiltered:"(filtered from _MAX_ total)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu: "Show _MENU_",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Məlumat tapılmadı"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
