...
!function (t, e) {
    ...
    const Ve = Object.freeze(Object.defineProperty({
        ...
        ei = u() ? "top-end" : "top-start", ii = u() ? "top-start" : "top-end",
        ni = u() ? "bottom-end" : "bottom-start", si = u() ? "bottom-start" : "bottom-end",
        oi = u() ? "left-start" : "right-start", ri = u() ? "right-start" : "left-start", ai = {
            autoClose: !0,
    ...
    const mi = "show", gi = "mousedown.bs.backdrop",
        _i = {className: "modal-backdrops", clickCallback: null, isAnimated: !1, isVisible: !0, rootElement: "body"},
        bi = {
            className: "string",
